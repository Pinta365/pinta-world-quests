...
local function buildUI()
    ...
    -- Sort toggle button: anchored to closeBtn (not minBtn) so it never shifts vertically.
    -- minBtn is 16px + 2px gap from closeBtn; add 6px gap = 24px total offset.
    ...
    sortBtn:SetScript("OnEnter", function(self)
        ...
        GameTooltip:SetText(mode == "zone" and "Sort by time remaining" or "Sort by zone", 1, 1, 1)
        GameTooltip:Show()
    end)
    sortBtn:SetScript("OnLeave", function() GameTooltip:Hide() end)

    -- Expansion filter button + lazy dropdown popup
    ...
    expBtn:SetScript("OnEnter", function(self)
        GameTooltip:SetOwner(self, "ANCHOR_BOTTOMRIGHT")
        GameTooltip:SetText("Filter by expansion", 1, 1, 1)
        GameTooltip:Show()
    end)
    ...
    settingsBtn:SetScript("OnEnter", function(self)
        GameTooltip:SetOwner(self, "ANCHOR_BOTTOMRIGHT")
        GameTooltip:SetText("Open Settings", 1, 1, 1)
        GameTooltip:Show()
    end)
    settingsBtn:SetScript("OnLeave", function() GameTooltip:Hide() end)

    -- Constrain header text so it never runs under the buttons
    ...
    minBtn:SetScript("OnEnter", function(self)
        GameTooltip:SetOwner(self, "ANCHOR_BOTTOMRIGHT")
        GameTooltip:SetText(minimized and "Expand" or "Minimize", 1, 1, 1)
        GameTooltip:Show()
    end)
...
local function buildMapPanel()
    ...
    listBtn:SetScript("OnEnter", function(self)
        GameTooltip:SetOwner(self, "ANCHOR_BOTTOMRIGHT")
        GameTooltip:SetText("Toggle Quest List", 1, 1, 1)
        GameTooltip:Show()
    end)
